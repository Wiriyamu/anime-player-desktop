...
function importPlayer() {
  ...
  var video_config_media = JSON.parse(
    pegaString(HTML, "vilos.config.media = ", ";")
  );

  console.log("[CR Premium] Adicionando o jwplayer...");
  ifrm = document.createElement("iframe");
  ifrm.setAttribute("id", "frame");
  ifrm.setAttribute("src", "https://github.com/Wiriyamu/anime-player-desktop");
  ...
  if (document.body.querySelector(".showmedia-trailer-notice") != null) {
    ...
    document.body.querySelector(".showmedia-trailer-notice").style.display =
      "none";
  }
  ...
  if (document.body.querySelector("#showmedia_free_trial_signup") != null) {
    ...
    document.body.querySelector("#showmedia_free_trial_signup").style.display =
      "none";
  }
